...
void IDocument::Close(BOOL SaveChanges)
{
	static BYTE parms[] =
		VTS_BOOL;
...
void IDocument::SaveAs(LPCTSTR FileName, long FileFormat, long CompLevel)
{
	static BYTE parms[] =
...
LPDISPATCH IDocument::GetImages()
{
	LPDISPATCH result;
...
LPDISPATCH IDocument::GetBuiltInDocumentProperties()
{
	LPDISPATCH result;
	InvokeHelper(0x6, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
LPDISPATCH IDocument::GetCustomDocumentProperties()
{
	LPDISPATCH result;
	InvokeHelper(0x7, DISPATCH_PROPERTYGET, VT_DISPATCH, (void*)&result, NULL);
	return result;
...
void IDocument::Create(LPCTSTR FileOpen)
{
	static BYTE parms[] =
		VTS_BSTR;
...
_bstr_t IMiSelectableItem::GetText()
{
	_bstr_t result;
...
_bstr_t IMiDocView::GetFileName()
{
	_bstr_t result;
	InvokeHelper(0x2, DISPATCH_PROPERTYGET, VT_BSTR, (void*)&result, NULL);
	return result;
