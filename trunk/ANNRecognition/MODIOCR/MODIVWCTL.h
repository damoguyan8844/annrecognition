...
#ifndef ANNRecognition_MODIVWCTL_H_
#define ANNRecognition_MODIVWCTL_H_

#include <atlbase.h>
#include <comutil.h>
#include <OleDispatchDriver.h>

struct ComEnvSetter
{
 	ComEnvSetter() { ::CoInitializeEx(0, COINIT_APARTMENTTHREADED); }
 	~ComEnvSetter() { ::CoUninitialize(); }
};
...
public:
	...
	_bstr_t GetText();//以单CString方式获得辨认文本
	LPDISPATCH GetWords();
};
/////////////////////////////////////////////////////////////////////////////
