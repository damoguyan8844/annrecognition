...
namespace ScreenCap
{
	...
	public class FormCapture: System.Windows.Forms.Form
	{
		...
		public delegate void  xx(Bitmap image);//定义一个委托
		public event xx dd;//事件
		Point op;
		...
		static void Main() 
		{
			Application.Run(new WindowsApplication1.FormMain());
		}
		...
		public  void  CaptureForm_DoubleClick(object sender, System.EventArgs e)
		{
